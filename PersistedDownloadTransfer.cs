...
namespace TransferManager
{
    ...
    /// </summary>
    [Table]
    [InheritanceMapping(Code = "PAG", Type = typeof(DownloadManager.Library.Page))]
    [InheritanceMapping(Code = "PDT", Type = typeof(DownloadTransfer), IsDefault = true)]
    public partial class PersistedDownloadTransfer : INotifyPropertyChanged, INotifyPropertyChanging, ITransferable
    {
